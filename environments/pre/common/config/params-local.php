...
return [
    ...
    'ossFileUrl' => 'http://pre-cdn.yesincarapi.com/',
    'shareTripLogoUrl'=>'https://pre-h5.yesincarapi.com/assets/images/passenger/logo_app_yeeping@3x.bd93a1ad.png',
    'shareTripH5Url'=>'https://pre-h5.yesincarapi.com/pages/share_itinerary.html',
    'serviceManPhone' => '18510924948',//接收短信客服手机号码
    'api' => [
        'order' => [//java订单服务
            'serverName' => 'https://pre-order.yesincarapi.com',
            'method' => [
        ...
        'dispatch' => [//java派单服务
            'serverName' => 'https://pre-dispatch.yesincarapi.com',
            'method' => [
        ...
        'account' => [//java用户中心
            'serverName' => 'https://pre-account.yesincarapi.com',
            'method' => [
        ...
        'message' => [//java消息服务
            'serverName' => 'https://pre-message.yesincarapi.com',
            'method' => [
        ...
        'map' => [//java地图服务
            'serverName' => 'https://pre-map.yesincarapi.com',
            'method' => [
        ...
        'valuation' => [//java计价服务
            'serverName' => 'https://pre-valuation.yesincarapi.com',
            'method' => [
        ...
        'pay' => [//java支付服务
            'serverName' => 'https://pre-pay.yesincarapi.com',
            'method' => [
        ...
        'statistics' => [ //java监控统计服务
            'serverName' => 'https://pre-monitor.yesincarapi.com',
            'method' => [
        ...
        'file' => [//java文件服务
            'serverName' => 'https://pre-file.yesincarapi.com',//'http://192.168.33.239:8089',
            'method' => [
    ...
    'phoneWhiteList' => [
        'verifyCode' => '112358',
        'phoneNum' =>['13466785081','17812369771','18584313239','13552827145','18519689163']
    ]
];
