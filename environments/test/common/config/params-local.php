...
return [
    ...
    'ossFileUrl'                  => 'http://test-cdn.yesincarapi.com/',
    'shareTripLogoUrl'=>'https://test-h5.yesincarapi.com/assets/images/passenger/logo_app_yeeping@3x.bd93a1ad.png',
    'shareTripH5Url'=>'https://test-h5.yesincarapi.com/pages/share_itinerary.html',
    'serviceManPhone' => '15801105167',//接收短信客服手机号码
    'api' => [
        'order' => [//java订单服务
            'serverName' => 'https://test-order.yesincarapi.com',
            'method' => [
        ...
        'dispatch' => [//java派单服务
            'serverName' => 'https://test-dispatch.yesincarapi.com',
            'method' => [
        ...
        'account' => [//java用户中心
            'serverName' => 'https://test-account.yesincarapi.com',
            'method' => [
        ...
        'message' => [//java消息服务
            'serverName' => 'https://test-message.yesincarapi.com',
            'method' => [
        ...
        'map' => [//java地图服务
            'serverName' => 'https://test-map.yesincarapi.com',
            'method' => [
        ...
        'valuation' => [//java计价服务
            'serverName' => 'https://test-valuation.yesincarapi.com',
            'method' => [
        ...
        'pay' => [//java支付服务
            'serverName' => 'https://test-pay.yesincarapi.com',
            'method' => [
        ...
        'statistics' => [ //java监控统计服务
            'serverName' => 'https://test-monitor.yesincarapi.com',
            'method' => [
        ...
        'file' => [//java文件服务
            'serverName' => 'https://test-file.yesincarapi.com',//'http://192.168.33.239:8089',
            'method' => [
        ...
        'base' => [//网约车数据上报java地址
            'serverName' => 'https://test-gov.yesincarapi.com',
            'method' => [
