 ...
 */
class DistributeRadiusSetController extends BossBaseController
{
    ...
    public function actionList()
    {
        try {
            ...
            $list = CarDispatchDistributeRadiusSet::lists($params, $pager);
            $count = CarDispatchDistributeRadiusSet::get_total_count($params);
    ...
    public function actionAdd()
    {
        try {
            ...
            list($city_code, $service_type_id, $min_radius, $min_radius_first_push_driver_count, $max_radius, $max_radius_first_push_driver_count) = $this->checkParams(false);
            ...
            $data['min_radius_first_push_driver_count'] = $min_radius_first_push_driver_count;
            $data['max_radius'] = $max_radius;
            $data['max_radius_first_push_driver_count'] = $max_radius_first_push_driver_count;
            $data['operator_id'] = $this->userInfo['id'];

            $res = CarDispatchDistributeRadiusSet::add($data);
    ...
    public function actionEdit()
    {
        try {
            ...
            list($city_code, $service_type_id, $min_radius, $min_radius_first_push_driver_count, $max_radius, $max_radius_first_push_driver_count, $id) = $this->checkParams(true);
            ...
            $res = CarDispatchDistributeRadiusSet::edit($id, $data);
    ...
    private function checkParams($check_id = true)
    {
        ...
        $min_radius_first_push_driver_count = Request::input('min_radius_first_push_driver_count');
        $max_radius = Request::input('max_radius');
        $max_radius_first_push_driver_count = Request::input('max_radius_first_push_driver_count');

        $attributes = ['city_code', 'service_type_id', 'min_radius', 'min_radius_first_push_driver_count', 'max_radius', 'max_radius_first_push_driver_count'];
        $rules = [
            [
                'city_code',
                'required',
        ...
        $res = [$city_code, $service_type_id, $min_radius, $min_radius_first_push_driver_count, $max_radius, $max_radius_first_push_driver_count];
    ...
    private function checkRepeat($city_code, $service_type_id, $id = false)
    {
        ...
        if (CarDispatchDistributeRadiusSet::checkData($city_code, $service_type_id, $id)) {
